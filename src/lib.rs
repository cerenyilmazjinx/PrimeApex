...
#[derive(Debug)]
pub struct PrimeApexProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrimeApexProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrimeApex processing");
    
    let mut processor = PrimeApexProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrimeApexProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrimeApexProcessor::new(false);
